...
class End extends React.Component {
  ...
  render() {
    ...
    return (
<Grid container direction="column" style={{backgroundColor:"#ffffff"}} alignItems='space-around' spacing= '16'>
                <Grid>
    <Grid item>
        <Card className={classes.card} >
  <Grid item xs={12} style={{paddingTop:0,marginTop: 20}} >       
<Typography type="caption" style={{fontWeight:600,paddingTop: 15,paddingLeft: 15,paddingRight: 10,paddingBottom: 15}}                                              className="tweetStats">
   <span style={{fontSize:"13px",color:"grey",fontWeight:600}} > ©2017 Twitter</span>
