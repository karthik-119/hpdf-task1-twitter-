...
<form className={classes.searchBar}>
      <input type="text" placeholder=" aadhar"             className={classes.input} spellCheck="false" autoComplete="false" contentEditable="false" onKeyPress={this.searchIt} onChange={evt=>this.updateInputVal(evt)}/>
     <span 
...
<Grid container direction="column" style={{background:"#FF0000",marginTop:0}}>
<Grid item xs={3} style={{backgroundcolor:"#000000"}}>  
<Typography type="display1" style={{marginLeft:130,marginTop:5,marginBottom:5,fontWeight:600,color:"#ffffff"}}>
                        aadhar
</Typography>
</Grid>
</Grid>
